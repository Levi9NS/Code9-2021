        ...
        public OfferedAnswer AddOfferedAnswer(OfferedAnswer offeredAnswer)
        {
            ...
            command += string.Format(@"INSERT INTO [Survey].[OfferedAnswers]
                                 ...
                                 VALUES
                                       ('{0}'
                                       ,'{1}'
                                       ,'{2}');", offeredAnswer.QuestionAnswer, "Nikola", DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff"));
        ...
        public Question AddQuestion(Question question)
        {
            ...
            command += string.Format(@"INSERT INTO [Survey].[Questions]
                        ...
                        VALUES
                           ...
                           ,'{1}'
                           ,'{2}');
                        SELECT SCOPE_IDENTITY();", question.QuestionText, "Nikola", DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff"));
            ...
            foreach(var id in offeredAnswersId)
            {
                command += string.Format(@"INSERT INTO [Survey].[QuestionOfferedAnswerRelations]
                        ...
                        VALUES
                           ('{0}'
                           ,'{1}' ,'{2}' ,'{3}' ,'{4}', '{5}' );
                            ", returnValue, id, "Nikola", DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff"), "Nikola", DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff"));
            }
        ...
        public SurveyQuestionRelation AddQuestionToSurvey(SurveyQuestionRelation surveyQuestionRelation)
        {
            ...
            command += string.Format(@"INSERT INTO [Survey].[SurveyQuestionRelations]
                        ...
                        VALUES
                           ('{0}'
                           ,'{1}' ,'{2}' ,'{3}' ,'{4}', '{5}' );
                            ", surveyId, questionId, "Nikola", DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff"), "Nikola", DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff"));
        ...
        public Participant AddParticipant(Participant participant)
        {
            ...
            command += string.Format(@"INSERT INTO [Survey].[Participants]
                        ...
                        VALUES
                           ...
                           ,'{5}'
                           ,'{6}')
                            ", participant.FirstName, participant.LastName, participant.Email, participant.Password, participant.SurveyId, "Nikola", DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff"));
            ...
            try
            {
                ...
                command += string.Format(@"INSERT INTO [Survey].[Answers]
                            ...
                            VALUES
                               ...
                               ,'{3}'
                               ,'{4}'
                               ,'{5}')", answer.ParticipantId, answer.SurveyId, answer.QuestionId, answer.QuestionAnsweredId, "Nikola", DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff"));
        ...
        public string addOfferedAnswer(OfferedAnswer oa)
        {
            ...
            _statement += String.Format(@"INSERT INTO [Survey].[OfferedAnswers] 
                                   (
                                    ...
                                    , oa.QuestionAnswer,
                                  "Nikola", DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff"),
                                  "Nikola", DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff"));
            SqlConnection _connection = GetConnection(_connectionString);
